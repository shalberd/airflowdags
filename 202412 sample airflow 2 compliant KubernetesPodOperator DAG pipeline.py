...
op_84d9f7e8_295e_4337_a8d3_e5cd7a97226a = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "NO_PROXY": ".cluster.local,.ocp4test.mycompany.com,.mycompany.com,.svc,.internals.mycompany.com,10.0.0.0/16,10.0.0.0/8,10.128.0.0/14,127.0.0.1,172.30.0.0/16,api-int.ocp4test.mycompany.com,localhost,ocp4test.mycompany.com,mycompany.com,registry.mycompany.com,mycompany.com,internals.mycompany.com",
