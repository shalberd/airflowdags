...
args = {
    "project_id": "HelloWorldS3Cors-0109152439",
}

dag = DAG(
    "HelloWorldS3Cors-0109152439",
    default_args=args,
...
op_5817981e_131b_42de_908b_9ddb22bbc68b = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "HelloWorldS3Cors-{{ ts_nodash }}",
    },
    in_cluster=True,
    config_file="None",
    dag=dag,
