...
args = {
    "project_id": "dagwithcode-0109153858",
}

dag = DAG(
    "dagwithcode-0109153858",
    default_args=args,
...
op_5817981e_131b_42de_908b_9ddb22bbc68b = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "dagwithcode-{{ ts_nodash }}",
    },
    in_cluster=True,
    config_file="None",
    dag=dag,
